...
#        print "Run:"+str(run)+"; Lumi:"+str(lumi)+"; Event:"+str(event)
        ...
        nTHINJets                  = skimmedTree.__getattr__('AK4deepCSVnJet')
        thinjetP4                  = skimmedTree.__getattr__('AK4deepCSVjetP4')
        thinJetCSV                 = skimmedTree.__getattr__('AK4deepCSVjetDeepCSV_b')
