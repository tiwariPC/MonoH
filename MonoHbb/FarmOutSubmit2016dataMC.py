...
outputdirname="Raman/AnalysisTuples_2016DataMC_V11/"
regions=['signal', 'wj', 'tt','zj']

#outputdirname="Raman/AnalysisTuples_2016DataMC_V5/TTBar/"
inputprefix="--input-dir=root://cmsxrootd.hep.wisc.edu//store/user/khurana/Raman/SkimmedTuples/V5/"
...
samples='''ZprimeToA0hToA0chichihbb_2HDM_MZp-1000_MA0-300_13TeV-madgraph ZprimeToA0hToA0chichihbb_2HDM_MZp-1000_MA0-300_13TeV-madgraph
...
def submitjobs(region_, scriptname):
    ...
    for line in f:
        a,b = line.split()
        datasetdet=[a,b]
        jobcommand = ("farmoutAnalysisJobs "+outputdirname_new+"/"+datasetdet[0]+" "+inputprefix+datasetdet[1]+"-CopyTree "+cmsswpath+" "+exepath_new+" --fwklite --input-files-per-job=10 --extra-inputs=MonoHbbQuantities.py,MonoHBranchReader.py,PileUpWeights.py,BTagCalibrationStandalone.cpp,BTagCalibrationStandalone.h,subjet_CSVv2_ichep.csv,CSVv2_ichep.csv")
