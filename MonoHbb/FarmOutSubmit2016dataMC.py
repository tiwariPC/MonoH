...
outputdirname="Raman/AnalysisTuples_2016DataMC_V10/"
...
ZJetsToNuNu_HT-400To600_13TeV-madgraph MonoH2016/V1/ZJetsToNuNu_HT-400To600_13TeV-madgraph
ZJetsToNuNu_HT-200To400_13TeV-madgraph MonoH2016/V1/ZJetsToNuNu_HT-200To400_13TeV-madgraph
...
def submitjobs(region_, scriptname):
    ...
    for line in f:
        a,b = line.split()
        datasetdet=[a,b]
        jobcommand = ("farmoutAnalysisJobs "+outputdirname_new+"/"+datasetdet[0]+" "+inputprefix+datasetdet[1]+" "+cmsswpath+" "+exepath_new+" --fwklite --input-files-per-job=10 --extra-inputs=MonoHbbQuantities.py,MonoHBranchReader.py,PileUpWeights.py,BTagCalibrationStandalone.cpp,BTagCalibrationStandalone.h,subjet_CSVv2_ichep.csv,CSVv2_ichep.csv")
