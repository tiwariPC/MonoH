...
def getRegionQuants():
    ...
    varlist=['Zmass','ZpT','hadrecoil','MET','lep1_pT','lep2_pT','lep1_iso','lep2_iso','jet1_pT','jet2_pT','jet1_eta','jet2_eta','jet1_csv','jet2_csv','njet','ntau','ntaucleaned','nele','nmu','lep1_dR_tau','lep2_dR_tau','min_lep_dR_tau']
